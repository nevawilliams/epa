...
# -----------------------------------------------------------------------------
# We train on 2015-2022 for two reasons:
...
# 2. We hold out 2023-2025 as validation and test sets to prove the model
#    works on data it has never seen, which is critical for credibility
# -----------------------------------------------------------------------------

train_data <- purrr::map_dfr(2015:2022, function(yr) {
